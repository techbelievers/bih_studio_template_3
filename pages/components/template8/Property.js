...
import HeroBanner1 from './detail-components/HeroBanner/PropertyDetailHeader';
...
import MahaRera from './detail-components/Maharera/MahaReraInformation';
import LocationMap from './detail-components/location/LocationMap';
import ContactSection from './detail-components/contact/ContactSection';
...
function App({ propertyDetails, headerData, galleryData }) {
  ...
  return (
    <div className="App">
      ...
      <ContactSection slug={propertyDetails.property_slug} />
